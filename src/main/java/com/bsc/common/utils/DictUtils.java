...
public class DictUtils {
    ...
    /**
     * 	在外部工具类中用这种方式声明一个dao
     * 	因为dao是mvc的一个组件，直接声明会报错private static DictMapper dictMapper = new DictMapper();这种传统方式不可行
     * 	所以找了一个SpringTool工具类作为dao的注入
     */
    private static DictMapper dictMapper = (DictMapper) SpringTool.getBean("dictMapper");
